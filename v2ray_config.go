...
func getRouteRules(cf conf.Conf, inPort int) []V2rayRouteRule {
...
func setV2rayConfigV4Inbounds(confv4 *V2rayConfigV4, inPort int) {
...
func getV2rayConfigV4(n V2rayNode, inPort int) io.Reader {
	...
	var rulesb []byte
	rulesb, _ = json.Marshal(getRouteRules(cf, inPort))
	...
	setV2rayConfigV4Inbounds(&vconf, inPort)
